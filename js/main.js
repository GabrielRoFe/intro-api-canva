function draw_cuadrado() {
  ...
  function draw_curvasB() {
    const canvas = document.getElementById("canvas_curvasB");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_curvasCB() {
    const canvas = document.getElementById("canvas_curvasCB");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
